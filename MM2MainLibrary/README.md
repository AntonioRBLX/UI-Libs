...
### Protect Library Gui
- ONLY USE THIS IF THE GAME YOU ARE RUNNING ON IS CRASHING OR DETECTING, KEEP INTO CONSIDERATION THAT EXECUTORS WHICH DON'T SUPPORT THIS FEATURE WILL ERROR
```lua
